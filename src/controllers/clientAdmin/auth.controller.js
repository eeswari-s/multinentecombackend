...
const login = asyncHandler(async (req, res) => {
  ...
  const { user, accessToken, refreshToken } = await adminAuthService.loginClientAdmin({
    tenantId,
...
const forgotPassword = asyncHandler(async (req, res) => {
  await adminAuthService.forgotPassword({ tenantId: requestContext.getTenantId(), email: req.body.email });
